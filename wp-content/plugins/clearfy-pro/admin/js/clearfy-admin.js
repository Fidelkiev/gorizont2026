(function( $ ) {
    ...
    $(function() {
        ...
        if (typeof $('.clearfy-color-input').wpColorPicker === 'function' && clearfy_settings.color_picker_enable) {
            $('.clearfy-color-input').wpColorPicker();
        }


        /**
         * Открыть список REST API зарегистрированных
         */
        $('.js-clearfy-rest-api-list-button').on('click', function(){
            $('.js-clearfy-rest-api-list').slideToggle();
        });
         ...
         * Load news
         *******************************************************************/
        if ( $('.js-wpshop-news').length ) {
            jQuery.get( 'https://wpshop.tech/api/clearfy.php', function( response ) {
                if ( response && response.html ) {
                    $('.js-wpshop-news').html(response.html);
                }
            });
        }
         ...
         * Remove ip lockout
         *******************************************************************/
        $('.js-clearfy-remove-lockout').on('click', function(){
...
function createCookie(name, value, days) {
    ...
    /* js generated YjDalUWkF2sMTMyMTMyVD9sbbrMkzdIIg */
